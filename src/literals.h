...
static constexpr const char *T__htm = ".htm"; // HTML/HTM: Web interface files
static constexpr const char *T__html = ".html"; // HTML/HTM: Web interface files
...
// MIME types (alphabetical)
static constexpr const char *T_app_xform_urlencoded = "application/x-www-form-urlencoded";
static constexpr const char *T_application_json = "application/json"; // JSON: Data exchange format
static constexpr const char *T_application_msgpack = "application/msgpack"; // Not required
static constexpr const char *T_application_octet_stream = "application/octet-stream";
static constexpr const char *T_application_pdf = "application/pdf"; // PDF: Universal document format
static constexpr const char *T_font_woff = "font/woff"; // WOFF: Universal browser support, good compression
static constexpr const char *T_font_woff2 = "font/woff2"; // WOFF2: Better compression, modern browser support
static constexpr const char *T_image_avif = "image/avif"; // AVIF: Next-generation format
static constexpr const char *T_image_gif = "image/gif"; // GIF: Simple animations, legacy support
static constexpr const char *T_image_jpeg = "image/jpeg"; // JPEG/JPG: Photos, complex images
static constexpr const char *T_image_png = "image/png"; // PNG: Icons, logos, screenshots
static constexpr const char *T_image_svg_xml = "image/svg+xml"; // SVG: Vector graphics
static constexpr const char *T_image_webp = "image/webp"; // WebP: Modern format with superior compression
static constexpr const char *T_image_x_icon = "image/x-icon"; // ICO: Favicons, system icons
static constexpr const char *T_text_event_stream = "text/event-stream"; 
static constexpr const char *T_text_css = "text/css"; // CSS: Styling for web interfaces
static constexpr const char *T_text_csv = "text/csv"; // CSV: Data logging and configuration
static constexpr const char *T_text_html = "text/html"; // HTML/HTM: Web interface files
static constexpr const char *T_text_javascript = "text/javascript"; // JavaScript: Interactive functionality
static constexpr const char *T_text_plain = "text/plain"; // TXT: Plain text files
static constexpr const char *T_text_xml = "text/xml"; // XML: Configuration and data files
static constexpr const char *T_video_mp4 = "video/mp4"; // MP4: Universal compatibility
static constexpr const char *T_video_ogg = "video/ogg"; // OGV: Ogg video container
static constexpr const char *T_video_webm = "video/webm"; // WebM: Open source video
static constexpr const char *T_audio_aac = "audio/aac"; // AAC: Efficient audio format
static constexpr const char *T_audio_mpeg = "audio/mpeg"; // MP3: Universal compatibility
static constexpr const char *T_audio_ogg = "audio/ogg"; // OGG: Open source audio
static constexpr const char *T_audio_opus = "audio/opus"; // OPUS: High compression audio
